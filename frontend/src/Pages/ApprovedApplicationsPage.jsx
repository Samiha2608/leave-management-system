...
const ApprovedApplicationsPage = ({ applications }) => {
  return (
    <div className="mb-8">
      <h2 className="text-xl font-bold text-green-700">Approved Applications</h2>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {applications.map((app) => (
              <tr key={app.id} className="bg-green-100 hover:bg-green-200">
                <td className="px-6 py-4 whitespace-nowrap flex items-center">
                  <FaCheckCircle className="text-green-500 mr-2" /> Approved
                </td>
